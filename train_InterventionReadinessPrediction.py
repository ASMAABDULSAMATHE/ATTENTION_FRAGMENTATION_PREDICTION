...
X=data[Intervention_Readiness_Score_col]
...
for col in Intervention_Readiness_Score_col:
...
plt.figure(figsize=(6,4))
sns.countplot(x="Intervention_Readiness_class",data=data)
plt.title(f"Distribution of Intervention Readiness Class")
plt.xlabel("Intervention Readiness Class")
plt.ylabel("Number of participants")
plt.show()

#Correlation Heatmap
plt.figure(figsize=(12,8))
corr=data[Intervention_Readiness_Score_col].corr()
sns.heatmap(corr,annot=True,cmap="coolwarm",fmt=".2f")
plt.title("Correlation Heatmap of Intervention Readiness Score Features and Target")
plt.show()
...
plt.ylabel('Intervention Readiness Score Variables')
plt.show()
